...
export default function DetailFish() {
  ...
  return loading ? <Spinner /> : 
    <div className='detailFish'>
      {check && check.find(item => item['Scientific Name'] === fish['Scientific Name']) ? <div><button onClick={handleRemove}>Remove</button> <SimplePopover handleAdd={handleAddEaten}/></div> : <button className='button'onClick={handleAddToFavs}>Add to your favorites/watchlist</button>}
